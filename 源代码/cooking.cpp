                ...
                if(it.value().putDishState() == "未做")
                    {
                        ...
                        ui->tableWidget->item(row_1,0)->setTextAlignment(Qt::AlignCenter);
                        ui->tableWidget->item(row_1,1)->setTextAlignment(Qt::AlignCenter);
                        row_1++;
                    }
                else if(it.value().putDishState() == "开始做")
                    {
                        ...
                        ui->tableWidget_2->item(row_2,0)->setTextAlignment(Qt::AlignCenter);
                        ui->tableWidget_2->item(row_2,1)->setTextAlignment(Qt::AlignCenter);//
                        row_2++;
                    }
                    else
                        {
                            ...
                            ui->tableWidget_3->setItem(row_3,0,new QTableWidgetItem(it.value().putDishName()));
                             ui->tableWidget_3->item(row_3,0)->setTextAlignment(Qt::AlignCenter);
                             row_3++;
                        }
            }
