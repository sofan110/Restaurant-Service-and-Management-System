...
#include "ui_managerdish.h"
#include <QMessageBox>

ManagerDish::ManagerDish(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ManagerDish)
{
    ui->setupUi(this);
    setWindowTitle("菜单管理界面");
...
ManagerDish::~ManagerDish()
{
    delete ui;
}

void ManagerDish::showDishMap()
{
    int rowcount = 0;
...
void ManagerDish::on_pushButton_2_clicked()
{
...
void ManagerDish::on_pushButton_clicked()
{
    int row = 0;
    int row_count = ui->tableWidget->rowCount();
...
void ManagerDish::closeEvent(QCloseEvent *event)
{
